...
newProjectForm.addEventListener('submit', e => {
    ...
    projectWindow(project.name, project.tasks.length);
...
function projectWindow(projectName, taskNumber){
